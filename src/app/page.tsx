  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8">
        {/* Hero Section */}
        <div className="min-h-[90vh] flex flex-col justify-center py-12 md:py-16 lg:py-20">
          <div className="text-center max-w-5xl mx-auto">
            {/* Status badge */}
            <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full glass mb-8 md:mb-10 lg:mb-12 animate-fade-in">
              <div className="w-2 h-2 rounded-full bg-digiko-primary animate-pulse" />
              <span className="text-responsive-sm text-gray-400 font-medium">Live on Klever Mainnet</span>
            </div>
            
            {/* Main headline */}
            <h1 className="text-mobile-6xl md:text-tablet-6xl lg:text-8xl font-semibold text-white mb-6 md:mb-7 lg:mb-8 leading-none tracking-tight">
              Your Complete
              <br />
            ...
            <p className="text-responsive-xl text-gray-400 mb-8 md:mb-10 lg:mb-12 max-w-3xl mx-auto leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center mb-12 md:mb-16 lg:mb-20">
              <Link
                href="/dashboard"
                className="w-full sm:w-auto group relative px-6 md:px-8 lg:px-10 py-4 md:py-4.5 lg:py-5 bg-digiko-primary text-white font-medium rounded-2xl transition-all duration-500 shadow-[0_0_40px_rgba(0,102,255,0.3)] hover:shadow-[0_0_60px_rgba(0,102,255,0.5)] hover:scale-105 overflow-hidden"
              >
                <span className="relative z-10 flex items-center justify-center gap-2 text-responsive-base">
                  Launch Dashboard
              ...
              <Link
                href="/documentation"
                className="w-full sm:w-auto px-6 md:px-8 lg:px-10 py-4 md:py-4.5 lg:py-5 glass-hover rounded-2xl font-medium text-white transition-all duration-500 hover:scale-105"
              >
                <span className="text-responsive-base">Documentation</span>
              </Link>
            </div>

            {/* Platform Stats */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 lg:gap-8 max-w-3xl mx-auto">
              <div className="text-center p-4 md:p-5 lg:p-6 rounded-2xl glass-hover transition-all duration-500">
                <div className="text-responsive-h2 font-mono font-medium text-white mb-2">6</div>
                <div className="text-responsive-sm text-gray-500">Core Products</div>
              </div>
              <div className="text-center p-4 md:p-5 lg:p-6 rounded-2xl glass-hover transition-all duration-500">
                <div className="text-responsive-h2 font-mono font-medium text-white mb-2">2</div>
                <div className="text-responsive-sm text-gray-500">Native Tokens</div>
              </div>
              <div className="text-center p-4 md:p-5 lg:p-6 rounded-2xl glass-hover transition-all duration-500">
                <div className="text-responsive-h2 font-mono font-medium text-white mb-2">10%</div>
                <div className="text-responsive-sm text-gray-500">Staking APR</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20 md:mb-24 lg:mb-32">
          <div className="text-center mb-10 md:mb-12 lg:mb-16">
            <h2 className="text-responsive-h2 text-white mb-3 md:mb-4">Platform Features</h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5 lg:gap-6">
            {/* Dashboard */}
            <Link href="/dashboard" className="group glass-hover rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500 hover:scale-[1.02]">
              <div className="flex items-start gap-4 md:gap-5 lg:gap-6">
                <div className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-digiko-primary/20 to-digiko-primary/5 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  <svg className="w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 text-digiko-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-responsive-h4 mb-2 md:mb-3 text-white group-hover:text-digiko-primary transition-colors duration-300">Dashboard</h3>
                  <p className="text-responsive-base text-gray-400 leading-relaxed mb-3 md:mb-4">
                    Comprehensive asset management interface. View balances, send transactions, and monitor your portfolio in real-time.
                  </p>
                  <div className="flex items-center gap-2 text-responsive-sm text-digiko-accent">
            ...
            {/* Staking */}
            <Link href="/staking" className="group glass-hover rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500 hover:scale-[1.02]">
              <div className="flex items-start gap-3 md:gap-4 lg:gap-6">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-digiko-accent/20 to-digiko-accent/5 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  <svg className="w-7 h-7 md:w-8 md:h-8 text-digiko-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
                  </svg>
                </div>
                <div className="flex-1">
                  <h3 className="text-responsive-h3 mb-2 md:mb-3 text-white group-hover:text-digiko-accent transition-colors duration-300">Staking</h3>
                  <p className="text-responsive-base text-gray-400 leading-relaxed mb-3 md:mb-4">
            ...
            {/* Swap - Coming Soon */}
            <div className="group glass rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500 relative overflow-hidden opacity-60">
              <div className="flex items-start gap-3 md:gap-4 lg:gap-6">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-gray-500/20 to-gray-500/5 flex items-center justify-center flex-shrink-0">
                  <svg className="w-7 h-7 md:w-8 md:h-8 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
                  </svg>
                </div>
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-3 mb-2 md:mb-3">
                    <h3 className="text-responsive-h3 text-white">Swap</h3>
                    <div className="px-2 md:px-3 py-1 md:py-1.5 rounded-md md:rounded-lg font-semibold text-xs tracking-wide backdrop-blur-xl border bg-digiko-accent/10 border-digiko-accent/30 text-digiko-accent w-fit">
                      Coming Soon
                    </div>
                  </div>
                  <p className="text-responsive-base text-gray-400 leading-relaxed">
            ...
            {/* Token Pages */}
            <div className="group glass-hover rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500">
              <div className="flex items-start gap-3 md:gap-4 lg:gap-6">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-digiko-accent/20 to-digiko-accent/5 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-500">
                  <svg className="w-7 h-7 md:w-8 md:h-8 text-digiko-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex-1">
                  <h3 className="text-responsive-h3 mb-2 md:mb-3 text-white">Token Information</h3>
                  <p className="text-responsive-base text-gray-400 leading-relaxed mb-3 md:mb-4">
                    Dedicated pages for DGKO and BABYDGKO with real-time stats, price charts, holder information, and ecosystem details.
                  </p>
                  <div className="flex gap-2 md:gap-3">
                    <Link href="/dgko" className="flex items-center gap-2 text-responsive-sm text-digiko-accent hover:text-white transition-colors">
                      <span>DGKO</span>
                      <svg className="w-3 h-3 md:w-4 md:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                      </svg>
                    </Link>
                    <Link href="/babydgko" className="flex items-center gap-2 text-responsive-sm text-digiko-accent hover:text-white transition-colors">
                      <span>BABYDGKO</span>
                      <svg className="w-3 h-3 md:w-4 md:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                      </svg>
            ...
            <div className="group glass rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500 relative overflow-hidden opacity-60">
              <div className="flex items-start gap-3 md:gap-4 lg:gap-6">
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-3 mb-2 md:mb-3">
                    <h3 className="text-responsive-h3 text-white">NFTs</h3>
                    <div className="px-2 md:px-3 py-1 md:py-1.5 rounded-md md:rounded-lg font-semibold text-xs tracking-wide backdrop-blur-xl border bg-digiko-accent/10 border-digiko-accent/30 text-digiko-accent w-fit">
                      Coming Soon
                    </div>
                  </div>
            ...
            <div className="group glass rounded-2xl md:rounded-3xl p-5 md:p-6 lg:p-8 transition-all duration-500 relative overflow-hidden opacity-60">
              <div className="flex items-start gap-3 md:gap-4 lg:gap-6">
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-3 mb-2 md:mb-3">
                    <h3 className="text-responsive-h3 text-white">Games</h3>
                    <div className="px-2 md:px-3 py-1 md:py-1.5 rounded-md md:rounded-lg font-semibold text-xs tracking-wide backdrop-blur-xl border bg-digiko-accent/10 border-digiko-accent/30 text-digiko-accent w-fit">
                      Coming Soon
                    </div>
                  </div>
        ...
        <div className="mb-20 md:mb-24 lg:mb-32">
          <div className="text-center mb-10 md:mb-12 lg:mb-16">
            <h2 className="text-responsive-h1 mb-3 md:mb-4 text-white">Ecosystem Tokens</h2>
            <p className="text-responsive-xl text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-5 lg:gap-6">
            {/* DGKO Token */}
            <Link href="/dgko" className="group glass rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 transition-all duration-500 hover:scale-[1.02] relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-5 lg:mb-6">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center flex-shrink-0 overflow-hidden shadow-[0_0_30px_rgba(0,102,255,0.3)]">
                    <TokenImage assetId={TOKEN_IDS.DGKO} size="xl" />
                  </div>
                  <div>
                    <h3 className="text-responsive-h3 text-white mb-1">DGKO</h3>
                    <p className="text-responsive-sm text-gray-500 font-mono">DGKO-CXVJ</p>
                  </div>
                </div>
                <p className="text-responsive-base text-gray-400 leading-relaxed mb-4 md:mb-5 lg:mb-6">
                  The primary utility token of the Digiko ecosystem. Used for staking, governance, and accessing platform features.
                </p>
                <div className="grid grid-cols-2 gap-3 md:gap-4 text-responsive-sm">
                  <div>
                    <div className="text-gray-500 mb-1">Max Supply</div>
                    <div className="text-responsive-base text-white font-medium">100 Million</div>
                  </div>
                  <div>
                    <div className="text-gray-500 mb-1">Staking APR</div>
                    <div className="text-responsive-base text-digiko-accent font-medium">10%</div>
                  </div>
                </div>
              </div>
            </Link>
            ...
            {/* BABYDGKO Token */}
            <Link href="/babydgko" className="group glass rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 transition-all duration-500 hover:scale-[1.02] relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-5 lg:mb-6">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center flex-shrink-0 overflow-hidden shadow-[0_0_30px_rgba(0,212,255,0.3)]">
                    <TokenImage assetId={TOKEN_IDS.BABYDGKO} size="xl" />
                  </div>
                  <div>
                    <h3 className="text-responsive-h3 text-white mb-1">BABYDGKO</h3>
                    <p className="text-responsive-sm text-gray-500 font-mono">BABYDGKO-3S67</p>
                  </div>
                </div>
                <p className="text-responsive-base text-gray-400 leading-relaxed mb-4 md:mb-5 lg:mb-6">
                ...
                <div className="grid grid-cols-2 gap-3 md:gap-4 text-responsive-sm">
                  <div>
                    <div className="text-gray-500 mb-1">Max Supply</div>
                    <div className="text-responsive-base text-white font-medium">50 Billion</div>
                  </div>
                  <div>
                    <div className="text-gray-500 mb-1">Staking APR</div>
                    <div className="text-responsive-base text-digiko-accent font-medium">10%</div>
        ...
        {/* Final CTA Section */}
        <div className="mb-20 md:mb-24 lg:mb-32">
          <div className="glass rounded-3xl md:rounded-[36px] lg:rounded-[40px] p-8 md:p-12 lg:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-responsive-h2 text-white mb-4 md:mb-5 lg:mb-6">
                Ready to Get Started?
              </h2>
              <p className="text-responsive-base text-gray-400 mb-8 md:mb-10 lg:mb-12 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                ...
                <Link
                  href="/documentation"
                  className="w-full sm:w-auto px-6 md:px-8 lg:px-10 py-4 md:py-4.5 lg:py-5 glass-hover rounded-2xl font-medium text-white transition-all duration-500 hover:scale-105 flex items-center justify-center gap-2"
                >
                  <span className="text-responsive-base">Read Documentation</span>
                </Link>
              </div>
            </div>
          </div>
