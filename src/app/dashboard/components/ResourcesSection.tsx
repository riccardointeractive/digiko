...
const RESOURCES: ResourceItem[] = [
  ...
  },
  {
    ...
    title: 'Documentation',
    description: 'Complete guide to using Digiko features and understanding the platform',
    variant: 'cyan',
    href: '/documentation',
  },
  {
...
export function ResourcesSection() {
  return (
    <div className="glass rounded-3xl p-8 border border-white/10">
      <h2 className="text-2xl font-medium text-white mb-8">Resources</h2>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {RESOURCES.map((item, i) => (
          <Link
            key={i}
            href={item.href}
            className="group flex items-start gap-4 p-5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/5 hover:border-digiko-primary/30 transition-all duration-300 cursor-pointer"
          >
