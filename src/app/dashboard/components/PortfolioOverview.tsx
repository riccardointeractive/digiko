  ...
  return (
    <div className="glass rounded-3xl p-6 lg:p-8 border border-white/5">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-sm font-medium text-gray-400">Your DGKO and BABYDGKO worth</h3>
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
        <div>
          ...
          <div className="text-lg font-mono font-semibold text-white">{stats.totalAssets}</div>
        </div>
        <div>
          <div className="text-xs text-gray-400 mb-1">Network</div>
          <div className="text-lg font-semibold text-white">Klever</div>
        </div>
      </div>
