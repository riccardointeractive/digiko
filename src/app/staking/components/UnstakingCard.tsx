  ...
  return (
    <div className="glass rounded-3xl p-8 border border-white/10">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-medium text-white">Unstake</h2>
        <button
          onClick={onRefresh}
          disabled={isLoading}
      ...
      <div className="mb-6 p-6 bg-klever-dark rounded-2xl border border-white/10">
        <div className="flex items-center justify-between mb-2">
          <span className="text-gray-400">Currently Staked</span>
          <span className="text-2xl font-mono font-medium text-white tabular-nums">{stakedBalance}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-gray-400 text-sm">Token</span>
          <span className="text-sm font-medium text-digiko-primary">{selectedToken}</span>
        </div>
      </div>

      <div className="mb-6 p-4 bg-digiko-primary/5 rounded-xl border border-digiko-primary/10">
      ...
      <button
        ...
        className="w-full py-4 bg-digiko-secondary hover:bg-digiko-blue-700 text-white font-medium rounded-2xl transition-all duration-500 shadow-[0_0_30px_rgba(0,82,204,0.3)] hover:shadow-[0_0_40px_rgba(0,82,204,0.4)] disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02] mb-6"
      >
