...
export function CTASection() {
  return (
    <div className="glass rounded-3xl p-8 md:p-12 border border-white/10 text-center">
      <h2 className="text-3xl font-medium text-white mb-4">Get BABYDGKO Today</h2>
      <p className="text-gray-400 mb-8 max-w-xl mx-auto">
        Join the fun side of the Digiko ecosystem. Stake your tokens, participate in community events, and earn rewards.
      </p>
      <div className="flex flex-wrap justify-center gap-4">
        ...
        >
          <span className="relative z-10">Stake BABYDGKO</span>
